...
public class PersonelController {
    ...
    public Personel getPersonel(@PathVariable("id") long id)
    {
        ...
        {
            throw new PersonelNotFoundException(id + "nolu personel bulunamadi!");
        }
    }
    @GetMapping("/personel")
    ...
    public List<Personel> getPersonelByBolumNo(long bolumNo)
    {
    ...
    private Bolum getBolum(long bolumNo)
    {
        ...
        Bolum bolumAd =  restTemplate.getForObject(bolumURL+"/bolum/"+bolumNo,Bolum.class);
